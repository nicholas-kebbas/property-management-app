import { APPLY_PROPERTY, REVIEW_APPLICATIONS, DELETE_APPLICATION, GET_APPLICATION, APPROVE_APP, DENY_APP, FETCH_ALL_APPLICATIONS, FETCH_MY_APPLICATIONS, FETCH_TENANT_MY_APPLICATION } from '../actions/types';
