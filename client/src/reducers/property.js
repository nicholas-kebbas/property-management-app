import { CREATE_PROPERTY, FETCH_PROPERTIES, GET_PROPERTY, SEARCH_PROPERTY, PERSIST_SEARCH_RESULTS, APPLY_PROPERTY, REVIEW_APPLICATIONS, FETCH_TENANTS } from '../actions/types';
